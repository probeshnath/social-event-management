        ...
        <div className='relative'>
            <div className="carousel w-full h-[450px]">
                <div id="item1" className="carousel-item relative w-full">
                    ...
                    <div className='absolute w-full h-full flex justify-between p-10 lg:p-20 bg-black bg-opacity-70 text-white'>
                ...
                <div id="item3" className="carousel-item relative w-full">
                    ...
                    <div className='absolute w-full h-full p-10 lg:p-20 bg-black bg-opacity-70 text-white'>
                        <div className='lg:w-1/2'>
                ...
                <div id="item4" className="carousel-item relative w-full">
                    ...
                    <div className='absolute w-full h-full flex  p-10 lg:p-20 bg-black bg-opacity-70 text-white'>
                        <div className='lg:w-1/2'>
